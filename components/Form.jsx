        ...
        <section className='w-full max-w-full flex-col flex-start'>
            ...
            <form onSubmit={handleSubmit} className='mt-10 w-full max-w-2xl flex flex-col gap-7 glassmorphism'>
                <label>
                    ...
                    <textarea value={post.entry} onChange={(e) => setPost({...post, entry: e.target.value})}
                              placeholder='Write your entry here' required className='form_textarea'/>
                </label>
                <label>
                    <span className='font-semibold text-base text-gray-800'>
                        Tag {' '}
                        <span className='font-light'>
                        (#happy, #inspiration, #idea)
                    </span>
                    </span>
